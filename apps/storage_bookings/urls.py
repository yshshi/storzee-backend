...
from .views import create_booking,update_luggage_deatils,update_luggage_location_by_saathi,get_luggage_deatils,validate_pickup,submit_to_rakshak,request_return,booking_details,booking_status,change_status,get_all_bookings,change_amount,get_detail_bookings,update_paymentStatus
...
urlpatterns = [
    ...
    re_path(r'^update_paymentStatus', update_paymentStatus, name='update_paymentStatus'),
